...
object MusicUnlockColors {
    ...
    val LightTextSecondary = Color(0xFF5F5F69)
    val LightTextMuted = Color(0xFF71717A)
    ...
    val LightWaitFg = Color(0xFF5F5F69)
    val LightWaitBg = Color(0xFFF4F4F7)
    val LightDupFg = Color(0xFF71717A)
    ...
    val DarkTextMuted = Color(0xFF8A8A95)
    ...
    val DarkDupFg = Color(0xFF8A8A95)
